...
public class BubbleCircleSpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < howMany; i++) {
            ...
            bubblyMovesComponentL1.y_speed = Random.value * 0.1f + 0.03f;
            bubblyMovesComponentL1.frequency  = Random.value *0.2f + 0.03f;
            ...
            bubblyMovesComponentL2.y_speed = Random.value * 0.1f + 0.03f;
            bubblyMovesComponentL2.frequency = Random.value * 0.2f + 0.03f;
